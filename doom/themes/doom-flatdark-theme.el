;;; doom-flatdark.el -*- lexical-binding: t; -*-

;;; doom-flatdark-theme.el --- inspired by Atom's Flatdark Syntax theme -*- lexical-binding: t; no-byte-compile: t; -*-
;;
;; Added: August 9, 2020 (#507)
;; Author: nhaydel <https://github.com/nhaydel>
;; Maintainer:
;; Source: https://github.com/nhaydel/dotfiles/tree/main/doom/themes/doom-flatdark-theme.el
;;
...
(defgroup doom-flatdark-theme nil
  "Options for the `doom-flatdark' theme."
  :group 'doom-themes)

(defcustom doom-flatdark-brighter-modeline nil
  "If non-nil, more vivid colors will be used to style the mode-line."
  :group 'doom-flatdark-theme
  :type 'boolean)

(defcustom doom-flatdark-no-highlight-variables nil
...
(def-doom-theme doom-flatdark
  "A minimal dark syntax theme"

  ;; name        default   256       16
  (
   (fw-base1           '("#b9a992" "#666666" "black"))
   (fw-base2           '("#c9903c" "#999966" "brightblack"))
   (fw-base3           '("#c9903c" "#cc9999" "brightblack"))
   (fw-base4           '("#454563" "#cccccc" "brightblack"))
   (fw-base5           '("#454563" "#cccccc" "brightblack"))
   (fw-base6           '("#242436" "#ffffcc" "brightblack"))
   (fw-base7           '("#0f0f17" "#ffffff" "brightblack"))
   ...
   (fw-orange-blend    '("#5b4343" "#ffcccc" "brightorange"))
   ...
   ;; custom categories
   (-modeline-bright doom-flatdark-brighter-modeline)
   (-no-highlight-variables doom-flatdark-no-highlight-variables)
   (-modeline-pad
  ...
  ((font-lock-builtin-face :inherit 'italic :foreground fw-green-blend :extend t)
   ((font-lock-doc-face &override) :slant 'italic)
   (font-lock-type-face :inherit 'default :foreground fw-green-blend)
   ...
   (font-lock-function-name-face        :foreground fw-teal-blend
                                        :weight 'semi-bold)
   ...
   ;;;; clojure
   (clojure-keyword-face :foreground fw-green-text
                         :background fw-green-blend)
...
;;; doom-flatdark-theme.el ends here
